...
# Title: Top Block
# Generated: Fri Dec  2 10:43:09 2016
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.blocks_file_sink_0 = blocks.file_sink(gr.sizeof_float*1, "/home/nitr/Sagnik/gnuradio_data/cyclo_1.dat", False)
        ...
        self.connect((self.blocks_complex_to_real_1, 0), (self.blocks_file_sink_0, 0))    
        self.connect((self.blocks_complex_to_real_1, 0), (self.wxgui_numbersink2_0_0, 0))    
        ...
        self.connect((self.blocks_vector_to_stream_0, 0), (self.wxgui_numbersink2_0, 0))    
